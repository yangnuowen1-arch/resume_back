...
func newApplication(db *gorm.DB, opts ...gen.DOOption) application {
	...
	_application.JobID = field.NewInt64(tableName, "job_id")
	_application.CandidateID = field.NewInt64(tableName, "candidate_id")
	_application.ResumeID = field.NewInt64(tableName, "resume_id")
	_application.Source = field.NewString(tableName, "source")
	_application.Status = field.NewString(tableName, "status")
	_application.ReceivedAt = field.NewTime(tableName, "received_at")
	_application.Remark = field.NewString(tableName, "remark")
	_application.CreatedBy = field.NewInt64(tableName, "created_by")
...
func (a *application) updateTableName(table string) *application {
	...
	a.JobID = field.NewInt64(table, "job_id")
	a.CandidateID = field.NewInt64(table, "candidate_id")
	a.ResumeID = field.NewInt64(table, "resume_id")
	a.Source = field.NewString(table, "source")
	a.Status = field.NewString(table, "status")
	a.ReceivedAt = field.NewTime(table, "received_at")
...
func (a *application) fillFieldMap() {
	...
	a.fieldMap["candidate_id"] = a.CandidateID
	a.fieldMap["resume_id"] = a.ResumeID
	a.fieldMap["source"] = a.Source
	a.fieldMap["status"] = a.Status
	a.fieldMap["received_at"] = a.ReceivedAt
